...
export const likePost = (likePost) => (dispatch) => {
  return LikeAPIUtil.likePost(likePost).then((like) =>
    dispatch(receiveLikePost(like))
  );
};

export const unlikePost = (postId) => (dispatch) => {
  return LikeAPIUtil.unlikePost(postId).then((like) =>
    dispatch(removeLikePost(like))
  );
};

export const fetchLikes = (postId) => (dispatch) => {
  return LikeAPIUtil.fetchLikes(postId).then((likes) =>
